    ...
    <main className="min-h-screen bg-background text-on-surface p-4 sm:p-6 pb-20">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center pt-2">
          <div>
            <h1 className="font-display font-black text-2xl italic tracking-tighter text-primary">FORJA</h1>
        ...
        <div className="relative bg-gradient-to-br from-[#1F2937] to-[#111827] border-2 border-primary-container/60 rounded-2xl p-6 shadow-2xl overflow-hidden">
          ...
          <div className="bg-black/60 rounded-xl p-3.5 border border-white/10 my-4 relative z-10">
            <div className="flex justify-between items-center text-xs font-mono mb-2">
              ...
              <span className="text-primary font-bold">Faixa Azul ({student.degrees} Graus)</span>
            </div>

            {/* Belt Graphic Bar */}
            <div className="w-full h-7 bg-blue-600 rounded-md relative flex items-center justify-end px-2 shadow-inner border border-blue-400">
              {/* Black Sleeve */}
          ...
          <div className="space-y-1 text-xs text-on-surface-variant relative z-10 font-mono">
            <div>
              <strong className="text-on-surface">Academia:</strong> {student.academy}
            </div>
            <div>
              <strong className="text-on-surface">Equipe:</strong> {student.team}
            </div>
          </div>
        </div>

        {/* Monthly Payment Status Widget */}
        <div className="bg-surface-container border border-outline-variant/40 rounded-xl p-5 shadow-lg space-y-3">
          <div className="flex justify-between items-center">
            <h3 className="font-bold text-sm text-on-surface flex items-center gap-2">
              <span className="material-symbols-outlined text-emerald-400 text-lg">verified</span>
              Status da Mensalidade
            </h3>
            <span className="text-xs bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 px-2.5 py-0.5 rounded font-mono font-bold">
              Em Dia
            </span>
          </div>
        ...
        <div className="bg-surface-container border border-outline-variant/40 rounded-xl p-5 shadow-lg space-y-2">
          <h3 className="font-bold text-sm text-on-surface flex items-center gap-2">
